    ...
    if(!empty($mainsection)){
      ...
      $mainsectionFooter1 = Section::where('id',4)->where('is_enable','1')->first();
       if(!empty($mainsectionFooter1)){
        ...
        $patientLibraryCategories=PatientLibraryCategory::all();
        $contents=Pagesection::where(["page"=>"patientlibrary"])->get();
        $patientLibrary_content = array();
        $patientLibraries = array();
        foreach($contents as $content){
            $patientLibrary_content[$content->section] = $content->toArray();
        }

        foreach($patientLibraryCategories as $patientLibrary){
          $patientLibraryCategory=PatientLibrary::where(["category_id"=>$patientLibrary->id])->get();
          $patientLibraries[$patientLibrary->id] = $patientLibraryCategory->toArray();
        }
        ...
        return view ('webpages.patientlibrary', compact('title','followusSection','topmenu_0','topmenu_1','topmenu_2','topmenu_3','topmenu_4','middlemenu_1','middlemenu_2','middlemenu_3','middlemenu_4','middlemenu_5','Mainmenu_1','Mainmenu_2','Mainmenu_3','Mainmenu_4','Mainmenu_5','Mainmenu_6','footermenu_1','footermenu_2','footermenu_3','footerContact','Bootomfooter','Know_Imc','News','testimonies','Award','Affiliates','slider','footermenu_1_sub','footermenu_2_sub','footermenu_3_sub','Mainmenu_1_sub','Mainmenu_2_sub','Mainmenu_3_sub','Mainmenu_4_sub','Mainmenu_5_sub','Mainmenu_6_sub','section','topmenu_section','middlemenu_section','Mainmenu_section','footermenu_section','Settings','patientLibraryCategories','patientLibrary_content','patientLibraries'));
    }
}
