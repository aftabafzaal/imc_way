...
class imc_homeController extends Controller {
    ...
    public function index() {
        ...
        if (!empty($mainsectionFooter1)) {
            ...
            $footermenu_4_sub = Footermenu::where('order', '4')->where('parent_id', '!=', '0')->where('is_active', '1')->get();
            $footermenu_5_sub = Footermenu::where('order', '5')->where('parent_id', '!=', '0')->where('is_active', '1')->get();
        ...
        if (!empty($mainsectionIMC)) {
            $Know_Imc = Know_Imc::where('is_active', '1')->get();
        } else {
            $Know_Imc = [];
        }
        ...
        if (!empty($mainsectionNews)) {
            $News = News::where('is_active_home', '1')->where('is_active', '1')->orderBy('is_order', 'asc')->orderBy('date', 'desc')->take('3')->get();
        } else {
            $News = [];
        }
        //Testimonies section
        ...
        if (!empty($mainsectionTestimonial)) {
            $testimonies = testimonies::where('is_active_home', '1')->where('is_active', '1')->orderBy('is_order', 'asc')->orderBy('created_at', 'desc')->get();
        } else {
            $testimonies = [];
        }
        //Awards section
        ...
        if (!empty($mainsectionAwards)) {
            $Award = Award::where('is_active', '1')->orderby('id', 'desc')->get();
            //Affiliates Section
            $Affiliates = Affiliate::where('is_active', '1')->first();
        } else {
            $Award = [];
            $Affiliates = [];
        }
