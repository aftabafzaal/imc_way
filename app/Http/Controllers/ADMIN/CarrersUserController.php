...
use App\CarrerUser;
use App\Helpers;
class CarrersUserController extends Controller implements UserInterface
{
     ...
     public function __construct()
           {
              ...
              $this->middleware(function ($request, $next) {
                ...
                if($user->role_id == 2){
                   ...
                   $helper = new Helpers();
                   if($path == "carrersusers/listing"){
                     $route= "listing";
                   }else if($path=="carrersusers/delete-single-user" || $path=="carrersusers/delete-multiple-users"){
                     $route="delete";
                   }
                  $checkpermision= $helper->checkpermission($user,1,$route);
  ...
  updateMultiUserStatus, ChangePassword, ChangePasswordSubmit, forgotpassword, resetPassword, resetPasswordSubmit functions
    ...
    */
    ...
    public function create()
    {
      ...
      return view('carrersusers.create');
   ...
   // save newly created users from this function
...

    {
        ...
        return redirect('/carrersusers/listing');
    ...
    public function listing(Request $request)
    {
        ...
        $users = CarrerUser::select('id', 'name', 'email', 'status', 'created_at','job','number','residency','nationality','resume','ip','media_resume');
        ...
        return view('carrersusers.view', compact('users'));
    ...
    {
        $user = \App\CarrerUser::find($request->id);
        $status = $user->delete();
    ...
    public function changeStatus(Request $request)
    {
        ...
        $result = CarrerUser::where('id', $request->id)->update(['status' => $request->status ]);//$user->save();
    ...
    public function editUser($id) {
        ...
        $user = CarrerUser::select('id', 'name', 'email')->where('id', $id)->first();
    ...
    public function SaveEditUser(Request $request) {
        ...
        $result = CarrerUser::where('id', $request->id)->update(['name' => $request->name ]);
    ...
    public function deleteMultiple(Request $request) {
        ...
        $result = CarrerUser::whereIn('id', $request->ids)->delete();
    ...
    public function updateMultiUserStatus(Request $request) {
        ...
        $result = CarrerUser::whereIn('id', $request->ids)->update(['status' => $request->status]);
