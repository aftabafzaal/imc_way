...
class TermController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            $academy->save();
            return redirect('admin/term/edit/3')->with("message","Terms updated")->with('alert-class', 'alert-success');
        }catch(Exception $e){
            return redirect('admin/term/edit/3')->with("message",$e->getMessage())->with('alert-class', 'alert-danger');
        }
    }
    ...
    {
        $academy = About::where('id','3')->first();
        return view("term.edit",compact("academy"));
    }
