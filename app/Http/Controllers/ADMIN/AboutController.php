...
class AboutController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            $academy->save();
            return redirect('admin/about/edit/1')->with("message","About us updated")->with('alert-class', 'alert-success');
        }catch(Exception $e){
            return redirect('admin/about/edit/1')->with("message",$e->getMessage())->with('alert-class', 'alert-danger');
        }
    }
    ...
    {
        $academy = About::where('id','1')->first();
        return view("about.edit",compact("academy"));
    }
