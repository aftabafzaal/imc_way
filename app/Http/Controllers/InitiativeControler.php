...
class InitiativeControler extends Controller {
    ...
    public function index() {
        ...
        //$helper = new Helpers();
        $language = ltrim(Request()->route()->getPrefix(), "/"); // Retrieving value "laravel-nepal" using key "name"
        ...
        $initiatives = Initiatives::where('status', '1')->where('initiatives.media_id', "!=", NULL)
                //->join('initiative_media', 'initiatives.id', '=', 'initiative_media.initiative_id')
                //->join('media', 'media.id', '=', 'initiative_media.media_id')
        ...
        return view('webpages.initiatives', compact('title', 'followusSection', 'topmenu_0', 'topmenu_1', 'topmenu_2', 'topmenu_3', 'topmenu_4', 'middlemenu_1', 'middlemenu_2', 'middlemenu_3', 'middlemenu_4', 'middlemenu_5', 'Mainmenu_1', 'Mainmenu_2', 'Mainmenu_3', 'Mainmenu_4', 'Mainmenu_5', 'Mainmenu_6', 'footermenu_1', 'footermenu_2', 'footermenu_3', 'footerContact', 'Bootomfooter', 'Know_Imc', 'News', 'Award', 'Affiliates', 'slider', 'footermenu_1_sub', 'footermenu_2_sub', 'footermenu_3_sub', 'Mainmenu_1_sub', 'Mainmenu_2_sub', 'Mainmenu_3_sub', 'Mainmenu_4_sub', 'Mainmenu_5_sub', 'Mainmenu_6_sub', 'section', 'topmenu_section', 'middlemenu_section', 'Mainmenu_section', 'footermenu_section', 'Settings', 'initiatives', 'helper'));
    }

    public function initiative($slug) {
        ...
        $initiatives = Initiatives::where('status', '1')
                ->where('status', '1')
                //->join('initiative_media', 'initiatives.id', '=', 'initiative_media.initiative_id')
                //->join('media', 'media.id', '=', 'initiative_media.media_id')
                //->groupBy("initiatives.id")
