@extends('layouts.app')
@section('title', 'Visitors Section')
@section('content')
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
											<select onchange="selectSection(this);" id="section" name="section"  class="form-control{{ $errors->has('template_id') ? ' is-invalid' : '' }}">
												...
												<option value="section_1">Visitors</option>
												<!-- <option value="section_2">Looking For Expert</option> -->
												<!-- <option value="section_3">Health Tips</option> -->
												<!-- <option value="section_4">Need A Doctor</option> -->
											</select>
										</div>
									</div>
									<div class="form-group row">
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/visitor/getSectionContent')}}",
		type:"POST",
...
function updateSection() {
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/visitor/updateSectionContent')}}",
			type:"POST",
