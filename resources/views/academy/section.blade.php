			...
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				...
				<div class="kt-section kt-section--first">
					<div class="kt-wizard-v4__form">
                        ...
                        <option value="section_1">Academy</option>
												<option value="section_2">Mission</option>
                        <option value="section_3">Vision</option>
                        <option value="section_4">Values</option>
                        <option value="section_5">Purposes</option>
                        <option value="section_6">About Academy</option>
                        <option value="section_7">Why the Academy</option>
                        <option value="section_8">Services</option>
											</select>
										</div>
									</div>
                  <div class="ajaxdata">
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/academy/getSectionContent')}}",
		type:"POST",
...
//  $('#iconFile')[0].files[0];
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/academy/updateSectionContent')}}",
			type:"POST",
