    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" method="POST" action="{{ url('eventheading/create') }}" >
                    @csrf
                    <input type="hidden" name="id" value="<?php if (!empty($editmenu->id)) {
    echo $editmenu->id;
} ?>" >
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group customlink">
                            ...
                            <input placeholder="Title in english " id="title_en" name="title_en" type="text" class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" value="<?php if (!empty($editmenu->title_en)) {
    echo $editmenu->title_en;
} ?>" autofocus>
<?php
if (isset($errors)) {
    ?>
...
?>
                        ...
                        <div class="form-group customlink">
                            ...
                            <input placeholder="Title in english " id="title_ar" name="title_ar" type="text" class="form-control {{ $errors->has('title_ar') ? ' is-invalid' : '' }}" value="<?php if (!empty($editmenu->title_ar)) {
    echo $editmenu->title_ar;
} ?>" autofocus>
                            <?php
                            if (isset($errors)) {
                                ?>
...
?>
                        ...
                        <div class="form-group customlink">
                            ...
                            <textarea name="description_en" class="form-control" aria-describedby="emailHelp" placeholder="Enter here" required><?php if (!empty($editmenu->description_en)) {
    echo $editmenu->description_en;
} ?></textarea>
                            <?php
                            if (isset($errors)) {
                                ?>
                        ...
                        <div class="form-group customlink">
                            ...
                            <textarea name="description_ar"  class="form-control" aria-describedby="emailHelp" placeholder="Enter here" required><?php if (!empty($editmenu->description_ar)) {
                                echo $editmenu->description_ar;
                            } ?></textarea>
<?php
if (isset($errors)) {
    ?>
