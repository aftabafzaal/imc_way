...
@section('title',  'Service Headline')
   ...
   <div class="col-md-12">
	   ...
	   <div class="kt-portlet">
                        ...
                        Headline</h3>
										...
										<!--begin::Form-->
										<form class="kt-form" method="POST" action="{{ url('serviceheading/create') }}" >
										@csrf
                      ...
                      <div class="kt-portlet__body">
                        <div class="form-group customlink">
                          ...
                          <input placeholder="Title in english " id="title_en" name="title_en" type="text" class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" value="<?php if(!empty($editmenu->title_en)){ echo $editmenu->title_en; }?>" autofocus>
                          <?php
                          if(isset($errors)){
                            ?>
                          ...
                          <div class="form-group customlink">
                            ...
                            <input placeholder="Title in english " id="title_ar" name="title_ar" type="text" class="form-control {{ $errors->has('title_ar') ? ' is-invalid' : '' }}" value="<?php if(!empty($editmenu->title_ar)){ echo $editmenu->title_ar; }?>" autofocus>
                            <?php
                            if(isset($errors)){
                              ?>
                              <span class="invalid-feed" role="alert">
