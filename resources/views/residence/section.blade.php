@extends('layouts.app')
@section('title', 'Residence Section')
@section('content')
...
<div class="kt-grid">
	<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
		...
		<form class="kt-form" id="section_form">
		  @csrf
			<input type="hidden" name="page" value="residence"/>
				...
				<div class="kt-section kt-section--first">
					<div class="kt-wizard-v4__form">
                        ...
                        <option value="banner">Banner</option>
												<option value="section_1">What is Graduate Medical Education?</option>
                        <option value="section_2">The Role of GME?</option>
                        <option value="section_3">History</option>
                        <option value="section_4">How to reach us</option>
											</select>
										</div>
									</div>
                  <div class="ajaxdata">
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/residence/getSectionContent')}}",
		type:"POST",
...
//  $('#iconFile')[0].files[0];
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/residence/updateSectionContent')}}",
			type:"POST",
