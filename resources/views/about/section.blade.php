...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
   <div class="kt-subheader__main">
	  ...
	  <div class="kt-subheader__breadcrumbs">
			...
			<a href="{{url('admin/about/edit/1')}}" class="kt-subheader__breadcrumbs-link">
				About us
			</a>
			<span class="kt-subheader__breadcrumbs-separator"></span>
			 About  Sections
   ...
   <div class="kt-subheader__toolbar">
      <a href="{{url('about/list/1/about')}}" class="btn btn-default btn-bold">
      Back </a>
   </div>
</div>
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/about/getSectionContent')}}",
		type:"POST",
...
//  $('#iconFile')[0].files[0];
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/about/updateSectionContent')}}",
			type:"POST",
