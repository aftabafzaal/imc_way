...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    ...
    <div class="kt-subheader__toolbar">
		...
		<a href="{{ url('admin/visitor/create') }}" class="btn btn-label-brand btn-bold">Create Visitor </a>
		<a href="{{ url('admin/visitor/section') }}" class="btn btn-label-brand btn-bold">Visitor Sections</a>                    
    </div>
</div>
							...
							<span style="overflow: visible; position: relative; width: 80px;">
							   <div class="dropdown">
								  ...
								  <div class="dropdown-menu dropdown-menu-right">
									 <ul class="kt-nav">									   
										<li class="kt-nav__item"><a class="kt-nav__link" href="{!!url('admin/visitor')!!}/{!!$visitor->id!!}/edit"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text">Edit</span></a></li>
			...
			if (ids.length > 0) {
				...
				swal.fire({
					...
					if (result.value) {
						$('.pageloader').show();
						$.ajax({
							url: "{{url('admin/visitor/deleteMultiple')}}",
							type: 'POST',
