...
<div class="kt-grid">
    ...
    <form class="kt-form" id="kt_apps_user_add_user_form" action="{{ url('admin/stayingimc')}}/{{$stayingimc->id}}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
			<!--begin: Form Wizard Step 1-->
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				<div class="kt-heading kt-heading--md">Edit StayingImc Details :</div>
				<div class="kt-section kt-section--first">
							...
							<div class="col-xl-12">
								<div class="kt-section__body">
									<div class="form-group row">
                                        ...
                                        <input placeholder="Title in english " id="title_en" name="title_en" type="text" class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" value="{{$stayingimc->title_en}}" autofocus>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
                                            <input placeholder="Title in Arabic " id="title_ar" name="title_ar" type="text" class="form-control {{ $errors->has('title_ar') ? ' is-invalid' : '' }} " value="{{$stayingimc->title_ar}}" autofocus>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
										<textarea id="description_en" name="description_en" placeholder="Content" id="description_en" class="form-control {{ $errors->has('description_en') ? ' is-invalid' : '' }}">{{$stayingimc->description_en}}</textarea>
                                    ...
                                    <div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
										<textarea id="description_ar" name="description_ar" placeholder="Content" id="description_ar" class="form-control {{ $errors->has('description_ar') ? ' is-invalid' : '' }}">{{$stayingimc->description_ar}}</textarea>
                  ...
                  ?>
                  <?php
                  $enImage= $helper->getImage($stayingimc->media_id_1);
                  ...
                  <?php
                     ...
                     ?>
                     <?php
                     $enImage= $helper->getImage($stayingimc->media_id_2);
                     $img=env('BASE_URL').$enImage;
                     ?>
                     @if(!empty($img))
                     <div class="form-group row">
                  ...
                  <?php
                     ...
                     ?>
                     <?php
                     $enImage= $helper->getImage($stayingimc->media_id_3);
                     $img=env('BASE_URL').$enImage;
                     ?>
                     @if(!empty($img))
                     <div class="form-group row">
