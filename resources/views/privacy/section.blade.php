...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
   <div class="kt-subheader__main">
	  ...
	  <div class="kt-subheader__breadcrumbs">
			...
			<a href="{{url('admin/privacy/edit/2')}}" class="kt-subheader__breadcrumbs-link">
				Privacy
			</a>
			<span class="kt-subheader__breadcrumbs-separator"></span>
			 Privacy Sections
   ...
   <div class="kt-subheader__toolbar">
      <a href="{{url('admin/privacy/edit/2')}}" class="btn btn-default btn-bold">
      Back </a>
   </div>
</div>
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/privacy/getSectionContent')}}",
		type:"POST",
...
//  $('#iconFile')[0].files[0];
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/privacy/updateSectionContent')}}",
			type:"POST",
