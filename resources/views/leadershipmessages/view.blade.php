...
@section('title', 'Leadership Mesages')
...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            ...
            <a href="{{ url('leadershipmessages/create') }}" class="btn btn-label-brand btn-bold">
                Add Leaderships Messages</a>
        </div>
    </div>
        ...
        <th data-field="ShipDate" class="kt-datatable__cell kt-datatable__cell--sort">
          ...
          Signature
           ...
           ?>
             ...
             <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 206px;">{{$page->subtitle_en}}</span></td>
						 <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 206px;">{{$page->created_at}}</span></td>
             <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 206px;">{{$page->signature}}</span></td>
							...
							<span style="overflow: visible; position: relative; width: 80px;">
							   <div class="dropdown">
								  ...
								  <div class="dropdown-menu dropdown-menu-right">
									 <ul class="kt-nav">
										<li class="kt-nav__item"><a class="kt-nav__link" href="{{url('leadershipmessages/edit', $page->id)}}"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text">Edit</span></a></li>
	...
	function deleteThis(obj, id)
	{
		swal.fire({
			...
			if (result.value) {
				$('.pageloader').show();
				$.ajax({
					url: "<?php echo url('leadershipmessages/delete-single-page'); ?>",
					type: 'POST',
			...
			if (ids.length > 0) {
				...
				swal.fire({
					...
					if (result.value) {
						$('.pageloader').show();
						$.ajax({
							url: "<?php echo url('leadershipmessages'); ?>" + '/delete-multiple-pages',
							type: 'POST',
