@extends('layouts.app')
@section('title', 'Add Patient Library')
@section('content')
...
<div class="kt-grid">
	<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
		...
		<form class="kt-form" id="kt_apps_user_add_user_form" action="{{ url('admin/patientlibrary')}}" method="POST" enctype="multipart/form-data">
          @csrf
			<!--begin: Form Wizard Step 1-->
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				<div class="kt-heading kt-heading--md">Add Patient Library :</div>
