...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__group" id="kt_subheader_search">
			...
			<form class="kt-margin-l-20" id="kt_subheader_search_form" action="{{url('/admin/department')}}" method="GET" role="search">
    ...
    <div class="kt-subheader__toolbar">
		...
		<a href="{{ url('admin/department/create') }}" class="btn btn-label-brand btn-bold">Create Department </a>
		<a href="{{ url('admin/department/section') }}" class="btn btn-label-brand btn-bold">Department Sections</a>
    </div>
</div>
							...
							<span style="overflow: visible; position: relative; width: 80px;">
							   <div class="dropdown">
								  ...
								  <div class="dropdown-menu dropdown-menu-right">
									 <ul class="kt-nav">
										<li class="kt-nav__item"><a class="kt-nav__link" href="{!!url('admin/department')!!}/{!!$survey->id!!}/edit"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text">Edit</span></a></li>
	...
	$(document).ready(function() {
		...
		$('#kt_subheader_group_actions_delete_all').on('click', function() {
			...
			if (ids.length > 0) {
				...
				swal.fire({
					buttonsStyling: false,
					text: "Are you sure to delete " + ids.length + " selected department?",
					type: "danger",
					confirmButtonText: "Yes, delete!",
					confirmButtonClass: "btn btn-sm btn-bold btn-danger",
					showCancelButton: true,
					...
					if (result.value) {
						$('.pageloader').show();
						$.ajax({
							url: "{{url('admin/department/deleteMultiple')}}",
							type: 'POST',
