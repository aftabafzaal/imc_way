            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                        ...
                        <form class="kt-form" id="kt_apps_user_add_user_form" action="{{ url('admin/department')}}/{{$survey->id}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                                ...
                                                <div class="kt-section__body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-8 col-xl-8">
                                                            <input placeholder="" id="title" name="slug_en" type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{$survey->slug_en}}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-8 col-xl-8">
                                                            <input placeholder="" id="title" name="slug_ar" type="text" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{$survey->slug_ar}}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea id="description_en" name="description_en" placeholder="Content" id="description_en" class="form-control {{ $errors->has('description_en') ? ' is-invalid' : '' }}">{!!$survey->description_en!!}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea id="description_ar" name="description_ar" placeholder="Content" id="description_ar" class="form-control {{ $errors->has('description_ar') ? ' is-invalid' : '' }}">{!!$survey->description_ar!!}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea id="service_en" name="service_en" placeholder="Content" id="service_en" class="form-control {{ $errors->has('service_en') ? ' is-invalid' : '' }}">{!!$survey->service_en!!}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea id="service_ar" name="service_ar" placeholder="Content" id="service_ar" class="form-control {{ $errors->has('service_ar') ? ' is-invalid' : '' }}">{!!$survey->service_ar!!}</textarea>
                                                    ...
                                                    @if(!empty($survey->media_id))
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label"></label>
                                                        <div class="col-md-8">
                                                            <?php
                                                            $enImage = $helper->getImage($survey->media_id);
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-8 col-xl-8">
                                                            <input type="checkbox" class="status" name="status" value="1" {{($survey->status == 1)?"checked":""}}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
