@extends('layouts.app')
@section('title', 'Edit Mayo questions')
@section('content')
...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
   <div class="kt-subheader__main">
	  ...
	  <div class="kt-subheader__breadcrumbs">
			...
			<a href="{{url('admin/mayo')}}" class="kt-subheader__breadcrumbs-link">
				Mayo
			</a>
			<span class="kt-subheader__breadcrumbs-separator"></span>
			Edit Mayo
...
<div class="kt-grid">
    ...
    <form class="kt-form" id="kt_apps_user_add_user_form" action="{{ url('admin/mayo')}}/{{$patientright->id}}" method="POST">
          @csrf
          @method('PUT')
			<!--begin: Form Wizard Step 1-->
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				<div class="kt-heading kt-heading--md">Edit mayo Details :</div>
