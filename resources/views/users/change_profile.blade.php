...
<div class="kt-grid">
	<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
		...
		<form class="kt-form" id="kt_apps_user_add_user_form" action="{{ url('users/change-profile-submit')}}" method="POST">
          ...
          @csrf
			...
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				<div class="kt-heading kt-heading--md">Change Profile :</div>
