              ...
              <div class="form-group row">
                    ...
                    <div class="col-lg-8 col-xl-8">
                      <input placeholder="Upload Image" id="image2" name="icon_ar" type="text" class="form-control {{ $errors->has('image1') ? ' is-invalid' : '' }}" value="{{old('icon_ar')}}" readonly>
                      @if ($errors->has('icon_ar'))
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $errors->first('icon_ar') }}</strong>
                        </span>
                      @endif
                    </div>
                    <div class="col-lg-1 col-xl-1">
                  ...
                  ?>
                  <?php
                  if(!empty($content->media_id_ar)){
                    $enImage= $helper->getImage($content->media_id_ar);
                    $img=env('BASE_URL').$enImage;
                  }else{
                    $img="";
                  }
