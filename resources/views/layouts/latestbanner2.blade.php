      ...
      <div class="banner-left">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active text-fff" aria-current="page"><a  class="text-fff" href="{{Config::get('variable.URL_LINK')}}/appointment">{!!($language == "en")?ucfirst($basedata['title_en']):ucfirst($basedata['title_ar'])!!}</a></li>
