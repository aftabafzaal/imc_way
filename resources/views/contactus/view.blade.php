...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__group" id="kt_subheader_search">
                ...
                <form class="kt-margin-l-20" id="kt_subheader_search_form" action="{{url('/search/contact')}}" method="GET" role="search">
                    <div class="kt-input-icon kt-input-icon--right kt-subheader__search">
						<input type="text" class="form-control" placeholder="Search..." id="generalSearch" name="name" value="{{session()->get( 'name' )}}">
               ...
               <tbody class="kt-datatable__body" style="">
				   @foreach($data as $user)
                            	...
                            	<div class="modal-dialog" role="document">
                            		 <div class="modal-content">
                            			 ...
                            			 <div class="modal-body">
                            				 <h6><b>{{smart_wordwrap($user->message, 11) . "\n"}}</b></h6>
                            			 </div>
					  ...
					  <td class="kt-datatable__cell--center kt-datatable__cell kt-datatable__cell--check" data-field="RecordID"><span style="width: 20px;"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid"><input type="checkbox" name="chkID[]" class="childBox" value="{{$user->id}}">&nbsp;<span></span></label></span></td>
						 ...
						 <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 206px;">{{$user->mobile}}</span></td>

			             <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 206px;">{{$user->subject}}</span></td>
						 ...
						 <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
							<span style="overflow: visible; position: relative; width: 80px;">
							     <?php
                                  ...
                                  $user=Auth::user();
                                  $checkpermision= $helper->checkpermission($user,4,"delete");
	...
	function deleteThis(obj, id)
	{
		swal.fire({
			...
			if (result.value) {
				$('.pageloader').show();
				$.ajax({
					url: "<?php echo url('/deletecontact'); ?>",
					type: 'POST',
			...
			if (ids.length > 0) {
				...
				swal.fire({
					...
					if (result.value) {
						$('.pageloader').show();
						$.ajax({
							url: "<?php echo url('deletemultiplecontact'); ?>",
							type: 'POST',
