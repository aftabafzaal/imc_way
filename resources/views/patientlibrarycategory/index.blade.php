@extends('layouts.app')
@section('title', 'Patient Library Category')
@section('content')
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">
            Patient Library Category
        </h3>
        <span class="kt-subheader__separator kt-subheader__separator--v"></span>
        <div class="kt-subheader__group" id="kt_subheader_search">
            <span class="kt-subheader__desc" id="kt_subheader_total">
            {{$patientlibrarycategories->total()}} Total</span>            
        </div>
    ...
    <div class="kt-subheader__toolbar">
		...
		<a href="{{ url('admin/patientlibrarycategory/create') }}" class="btn btn-label-brand btn-bold">Create Patient Library Category </a>
		<a href="{{ url('admin/patientlibrary') }}" class="btn btn-label-warning btn-bold">Patient Library</a>
    </div>
</div>
      ...
      <div class="kt-portlet__body kt-portlet__body--fit">
         ...
         <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded" id="kt_apps_user_list_datatable" style="">
            <table class="kt-datatable__table" style="display: block; min-height: 500px;">
			   ...
			   <tr class="kt-datatable__row" style="left: 0px;">
                    ...
                    <th class="kt-datatable__cell kt-datatable__cell--sort ">
                        <span style="width: 200px;">Category Name(EN)</span>						
                    </th>
                    <th class="kt-datatable__cell kt-datatable__cell--sort ">
                        <span style="width: 200px;">Category Name(AR)</span>						
                    </th> 
                    <th class="kt-datatable__cell kt-datatable__cell--sort ">
               ...
               <tbody class="kt-datatable__body" style="">
					  ...
					  <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
					    <td class="kt-datatable__cell--center kt-datatable__cell kt-datatable__cell--check" data-field="id">
                          <span style="width: 20px;"><label class="kt-checkbox kt-checkbox--single kt-checkbox--solid">
                              <input type="checkbox" name="id[]" class="childBox" value="{{$patientlibrarycategory->id}}">&nbsp;<span></span></label>
                            </span>
                        </td>
						<td class="kt-datatable__cell--sorted kt-datatable__cell" data-field="category_name_en">
							<span style="width: 200px;">
							    <span style="width: 206px;">{{$patientlibrarycategory->category_name_en}}</span>
							</span>
                        </td>
                        <td class="kt-datatable__cell--sorted kt-datatable__cell" data-field="category_name_ar">
                            <span style="width: 200px;">
                                <span style="width: 206px;">{{$patientlibrarycategory->category_name_ar}}</span>
                            </span>
                        </td>
						 <td class="kt-datatable__cell"><span style="width: 206px;">{{date('d-m-Y H:i:s',strtotime($patientlibrarycategory->created_at))}}</span></td>
							...
							<span style="overflow: visible; position: relative; width: 80px;">
							   <div class="dropdown">
								  ...
								  <div class="dropdown-menu dropdown-menu-right">
									 <ul class="kt-nav">									   
										<li class="kt-nav__item"><a class="kt-nav__link" href="{!!url('admin/patientlibrarycategory')!!}/{!!$patientlibrarycategory->id!!}/edit"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text">Edit</span></a></li>
									 	<li onclick="deleteThis(this, {{$patientlibrarycategory->id}})" class="kt-nav__item delete_user"><a class="kt-nav__link delete_user" href="javascript:void(0);"><i class="kt-nav__link-icon flaticon2-trash"></i><span class="kt-nav__link-text delete_user">Delete</span>
									 </ul>
								  </div>
							   </div>
							</span>
				 ...
				 @if(count($patientlibrarycategories) == 0)
				 <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
            ...
            <div class="kt-datatable__pager kt-datatable--paging-loaded">
				{{ $patientlibrarycategories->links() }}
                <div class="kt-datatable__pager-info">
                    ...
                    <span class="kt-datatable__pager-detail">Showing {{$patientlibrarycategories->firstItem()}} - {{$patientlibrarycategories->lastItem()}} of {{$patientlibrarycategories->total()}}</span>
                </div>
			</div>
         </div>
         <!--end: Datatable -->
...
<script>
	function deleteThis(obj, id)
	{
		swal.fire({
			...
			text: "Are you sure to delete this patient library?",
			type: "danger",
			...
			if (result.value) {
				$('.pageloader').show();
				$.ajax({
					url: "{{url('admin/patientlibrarycategory')}}/"+id,
					type: 'post',
	...
	$(document).ready(function() {
		...
		$('#kt_subheader_group_actions_delete_all').on('click', function() {
			...
			if (ids.length > 0) {
				...
				swal.fire({
					buttonsStyling: false,
					text: "Are you sure to delete " + ids.length + " selected patient libraries?",
					type: "danger",
					confirmButtonText: "Yes, delete!",
					confirmButtonClass: "btn btn-sm btn-bold btn-danger",
					showCancelButton: true,
					...
					if (result.value) {
						$('.pageloader').show();
						$.ajax({
							url: "{{url('admin/patientlibrarycategory/deleteMultiple')}}",
							type: 'POST',
