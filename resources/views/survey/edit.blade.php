...
<div class="kt-grid">
    ...
    <form class="kt-form" id="kt_apps_user_add_user_form" action="{{ url('admin/survey')}}/{{$survey->id}}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
			<!--begin: Form Wizard Step 1-->
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				<div class="kt-heading kt-heading--md">Edit Survey Details :</div>
				<div class="kt-section kt-section--first">
					<div class="kt-wizard-v4__form">
							...
							<div class="col-xl-12">
								<div class="kt-section__body">
									<div class="form-group row">
                                        ...
                                        <input placeholder="Title in english " id="title_en" name="title_en" type="text" class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" value="{{$survey->title_en}}" autofocus>											
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
                                            <input placeholder="Title in Arabic " id="title_ar" name="title_ar" type="text" class="form-control {{ $errors->has('title_ar') ? ' is-invalid' : '' }} " value="{{$survey->title_ar}}" autofocus>											
									...
									<div class="form-group row">
										...
										<div class="col-md-8">
											<div class="custom-file">
												<input  accept="image/*" type="file" class="custom-file-input" id="iconFile"  name="image">
									...
									<div class="form-group row">
										...
										<div class="col-md-8">
											<img id="iconPreview" width="150px" src="{{asset('images/surveys/images/')}}/{{$survey->image}}">
										</div>
									</div>
                                  ...
                                  <div class="p_scents">
                                  	...
                                  	{{--
                                   @if(!empty($question))                                  
                                   @foreach($question as $ques => $qu)

                                  
                                     <div class="deleteSurveyForm">
									 
										
                                   	<p>
                                   	 <input type="hidden" name="q_id[]" value="{{$qu['id']}}">

									<div class="form-group row">
										<label class="col-xl-2 col-lg-2 col-form-label"> Question (En)</label>
										<div class="col-lg-9 col-xl-9">
                                            <input placeholder="Question in english " id="title_ar" name="question_en[]" type="text" class="form-control" value="{{$qu['question_en']}}" autofocus>	
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
                                           <input placeholder="Question in Arabic" id="title_ar" name="question_ar[]" type="text" value="{{$qu['question_ar']}}" class="form-control">                                            
										</div>
									</div>
								...
								<!-- <div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
                                            ...
                                            <input placeholder="Answer En(1)" id="answer_en" name="answer_en[]" type="text" class="form-control" value="{{$qu['answer_en']}}">

                                            <input placeholder="Answer Ar(1)" id="answer_ar" name="answer_ar[]" type="text" class="form-control" value="{{$qu['answer_en']}}">

                                            <input placeholder="Answer En(2)" id="answer_en" name="answer_en2[]" type="text" class="form-control" value="{{$qu['answer_en2']}}">	

                                            <input placeholder="Answer Ar(2)" id="answer_ar" name="answer_ar2[]" type="text" class="form-control" value="{{$qu['answer_ar2']}}">

                                            <input placeholder="Answer En(3)" id="answer_en" name="answer_en3[]" type="text" class="form-control" value="{{$qu['answer_en3']}}">	

                                            <input placeholder="Answer Ar(3)" id="answer_ar" name="answer_ar3[]" type="text" class="form-control" value="{{$qu['answer_ar3']}}">

                                            <input placeholder="Answer En(4)" id="answer_en" name="answer_en4[]" type="text" class="form-control" value="{{$qu['answer_en4']}}">	

                                            <input placeholder="Answer Ar(4)" id="answer_ar" name="answer_ar4[]" type="text" class="form-control" value="{{$qu['answer_ar4']}}">

                                             <input placeholder="Answer En(5)" id="answer_en" name=
                                             "answer_en5[]" type="text" class="form-control" value="{{$qu['answer_en5']}}">	

                                            <input placeholder="Answer Ar(5)" id="answer_ar" name="answer_ar5[]" type="text" class="form-control" value="{{$qu['answer_ar5']}}">


                                            <input placeholder="Answer En(6)" id="answer_en" name="answer_en6[]" type="text" class="form-control" value="{{$qu['answer_en6']}}">	

                                            <input placeholder="Answer Ar(6)" id="answer_ar" name="answer_ar6[]" type="text" class="form-control" value="{{$qu['answer_ar6']}}">
                                    ...
                                    @if($ques > 0)
									<a href="javascript:void(0)" class="btn btn-danger deleteNewEducations" id="remScnt"><i class="fa fa-trash"></i></a>
								    </p>
						...
						<div class="col-sm-4">
							<button class="btn btn-warning newEducation" type="button">Add New Survey</button>
						</div>
					</div>
								</div>
							</div>
