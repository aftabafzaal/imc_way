			...
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				...
				<div class="kt-section kt-section--first">
                  ...
                  <div class="form-group row">
                    ...
                    <select class="custom-select form-control" name="year">
                      ...
                      for($i = 1950 ; $i < date('Y'); $i++){
                       ?>
                       <option <?php if(!empty($editmenu->year) && $editmenu->year==$i){ echo "selected"; }?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                       <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-9">
                    <textarea class="form-control" id="description_en" name="description_en" placeholder="Content" id="description_en" class="form-control">{!! (isset($page) && $page !='') ? $page->description_en : '' !!}</textarea>
                    ...
                    <div class="col-lg-9 col-xl-9">
                    <textarea class="form-control" id="description_ar" name="description_ar" placeholder="Content" id="description_ar" class="form-control">{!! (isset($page) && $page !='') ? $page->description_ar : '' !!}</textarea>
