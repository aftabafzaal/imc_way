...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">
            {{(isset($page->id) ? 'Edit' : 'Add')}} Histories
        </h3>
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                        ...
                        <form class="kt-form" id="kt_apps_user_add_user_form" action="{{ url('histories/store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <!--begin: Form Wizard Step 1-->
                            <div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                                <div class="kt-heading kt-heading--md">{{ isset($page->id) ? 'Edit' : 'Add' }} Tips :</div>
                                                ...
                                                <div class="kt-section__body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input style="display:none" name="id" value="{{ isset($page->id) ? $page->id : '' }}">
                                                            <input placeholder="name " id="title_en" name="title_en" value="{{ isset($page->id) ? $page->title_en : '' }}" type="text" class="form-control{{ $errors->has('title_en') ? ' is-invalid' : '' }}" required autofocus>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input placeholder="name" id="title_ar" name="title_ar" value="{{ isset($page->id) ? $page->title_ar : '' }}" type="text" class="form-control{{ $errors->has('title_ar') ? ' is-invalid' : '' }}" required autofocus>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-2 col-lg-2 col-form-label">Year</label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <select class="custom-select form-control" name="year">
                                                                ...
                                                                for ($i = 1950; $i < date('Y'); $i++) {
                                                                    ?>
                                                                    <option <?php
                                                                    if (!empty($editmenu->year) && $editmenu->year == $i) {
                                                                        echo "selected";
                                                                    }
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea class="form-control" id="description_en" name="description_en" placeholder="Content" id="description_en" class="form-control">{!! isset($page->id) ? $page->description_en : '' !!}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea class="form-control" id="description_ar" name="description_ar" placeholder="Content" id="description_ar" class="form-control">{!! isset($page->id) ? $page->description_ar : '' !!}</textarea>
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12">
                                                            ...
                                                            <div class="kt-radio-inline">
                                                                <label class="kt-radio">
                                                                    <input type="radio" value="1" name="is_active" <?php
                                                    if (empty($editmenu->id)) {
                                                        echo "checked";
                                                    }
                                                    ?> <?php
                                                                    if (!empty($editmenu->is_active) && $editmenu->is_active == "1") {
                                                                        echo "checked";
                                                                    }
                                                                    ?>>Active
                                                                    <span></span>
                                                                ...
                                                                <label class="kt-radio">
                                                                    <input type="radio" value="2" name="is_active" <?php
                                                                    if (!empty($editmenu->is_active) && $editmenu->is_active == "2") {
                                                                        echo "checked";
                                                                    }
                                                                    ?>> Inactive
                                                                    <span></span>
