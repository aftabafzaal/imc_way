@extends('layouts.app')
@section('title', 'Appointment Section')
@section('content')
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
											<select onchange="selectSection(this);" id="section" name="section"  class="form-control{{ $errors->has('template_id') ? ' is-invalid' : '' }}">
												...
												<option value="section_1">Appointment and Admission</option>
												<option value="section_2">Admission Process</option>
												<option value="section_3">Visiting Hours</option>
												<option value="section_4">What To Bring</option>
												<!-- <option value="section_4">Get the Right</option> -->
											</select>
										</div>
									</div>
									<div class="form-group row">
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/appointment/getSectionContent')}}",
		type:"POST",
...
function updateSection() {
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/appointment/updateSectionContent')}}",
			type:"POST",
