...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
   <div class="kt-subheader__main">
	  ...
	  <div class="kt-subheader__breadcrumbs">
			...
			<a href="{{url('admin/location')}}" class="kt-subheader__breadcrumbs-link">
				Location
			</a>
			<span class="kt-subheader__breadcrumbs-separator"></span>
			Add Location
   ...
   <div class="kt-subheader__toolbar">
      <a href="{{url('admin/location')}}" class="btn btn-default btn-bold">
      Back </a>
   </div>
</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-9">
															<select onchange="selectSection(this);" id="section" name="section"  class="form-control{{ $errors->has('template_id') ? ' is-invalid' : '' }}">
																...
																<option value="section_1">Visit Us</option>
																<option value="section_2">For Further Information</option>
																<!-- <option value="section_3">Get the Right</option> -->
															</select>
														</div>
													</div>
													<div class="form-group row">
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/location/getSectionContent')}}",
		type:"POST",
...
function updateSection() {
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/location/updateSectionContent')}}",
			type:"POST",
