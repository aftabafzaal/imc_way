@extends('layouts.app')
@section('title', 'Terms & conditions Section')
@section('content')
...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
   <div class="kt-subheader__main">
	  ...
	  <div class="kt-subheader__breadcrumbs">
			...
			<a href="{{url('admin/term/edit/2')}}" class="kt-subheader__breadcrumbs-link">
				Privacy
			</a>
			<span class="kt-subheader__breadcrumbs-separator"></span>
			 Privacy Sections
   ...
   <div class="kt-subheader__toolbar">
      <a href="{{url('admin/term/edit/2')}}" class="btn btn-default btn-bold">
      Back </a>
   </div>
</div>
...
<div class="kt-grid">
	<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
		...
		<form class="kt-form" id="section_form">
		  @csrf
			<input type="hidden" name="page" value="term"/>
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				...
				<div class="kt-section kt-section--first">
					<div class="kt-wizard-v4__form">
                        ...
                        <option value="section_1">section first</option>
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/term/getSectionContent')}}",
		type:"POST",
...
//  $('#iconFile')[0].files[0];
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/term/updateSectionContent')}}",
			type:"POST",
