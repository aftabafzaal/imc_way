...
(function( $ ) {
    $(document).ready(function(){
        ...
        $(".rs-addon-not-installed").click(function(){
            ...
            $.ajax({
                url : rev_slider_addon.ajax_url + '&action=install_plugin',
                type : 'post',
                data : {
        ...
        $(".rs-addon-not-activated").click(function(){
            ...
            $this = $(this);
            $.ajax({
                url : rev_slider_addon.ajax_url + '&action=activate_plugin',
                type : 'post',
                data : {
                    nonce: 	$('#ajax_rev_slider_addon_nonce').text(),// The security nonce
                    plugin: $this.data("plugin")
        ...
        $(".rs-dash-deactivate-addon").click(function(){
            ...
            $.ajax({
                url : rev_slider_addon.ajax_url + '&action=deactivate_plugin',
                type : 'post',
                data : {
                    nonce: 	$('#ajax_rev_slider_addon_nonce').text(),// The security nonce
                    plugin: $this.data("plugin")
