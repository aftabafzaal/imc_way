    ...
    protected function _get_photos($relation_value = null, $type = 'image')
    {
        ...
        foreach ($results as $num => $row) {
            ...
            if ($type == 'image') {
                ...
                $imageSize = @getimagesize($this->image_path . '/' . $row->{$this->url_field});
                $results[$num]->width = isset($imageSize[0]) ? $imageSize[0] : '';
                $results[$num]->height = isset($imageSize[1]) ? $imageSize[1] : '';
