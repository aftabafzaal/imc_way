...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__toolbar">
	            ...
	            <a href="{{ url('admin/mainmenu/list') }}" class="btn btn-label-brand btn-bold">Add Menu </a>          
				<?php  }elseif(!empty($editmenu->id) && $submenu==1){ ?>
					<a href="<?php echo url('admin/mainmenu/list/'.$parentId.'/submenu'); ?>" class="btn btn-label-brand btn-bold">
						Add Menu </a>          
				<?php  }?>		
				<a href="{{ url('admin/testimonies/section') }}" class="btn btn-label-brand btn-bold">Testimonies Sections</a>          			
             </div>
...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
   ...
   <div class="col-md-6">
	   ...
	   <div class="kt-portlet">
										...
										<input type="hidden" name="id" value="<?php if(!empty($Testimony->id)){ echo $Testimony->id; }?> " >
										...
										<input type="hidden" name="parent_id" value="" >
												<div class="form-group">
													<label>Name(EN)</label>
													<input type="text" required name="name_en" value="<?php if(!empty($Testimony->name_en)){ echo $Testimony->name_en; }?>" class="form-control" aria-describedby="emailHelp" placeholder="Enter name in english">
												</div>
												<div class="form-group">
													<label>Name(AR)</label>
												...
												<div class="form-group">
													...
													<input type="text" required name="testimony_en" value="" class="form-control" aria-describedby="emailHelp" placeholder="Enter testimony in english">
												</div>


												<div class="form-group">
													<label>Testimony(AR)</label>
													<input type="text" required name="testimony_ar" value="" class="form-control" aria-describedby="emailHelp" placeholder="Enter testimony in arabic">
												</div>
