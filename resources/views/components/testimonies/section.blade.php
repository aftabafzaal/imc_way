@extends('layouts.app')
@section('title', 'Testimonies Section')
@section('content')
...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
   <div class="kt-subheader__main">
	  ...
	  <div class="kt-subheader__breadcrumbs">
			...
			<a href="{{url('admin/testimonies')}}" class="kt-subheader__breadcrumbs-link">
				Testimonies 
			</a>
			<span class="kt-subheader__breadcrumbs-separator"></span>
			Add Testimonies			
   ...
   <div class="kt-subheader__toolbar">
      <a href="{{url('admin/testimonies')}}" class="btn btn-default btn-bold">
      Back </a>
   </div>
</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
											<select onchange="selectSection(this);" id="section" name="section"  class="form-control{{ $errors->has('template_id') ? ' is-invalid' : '' }}">
												...
												<option value="section_1">PATIENT & TESTIMONIAL</option>
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/testimonies/getSectionContent')}}",
		type:"POST",
...
function updateSection() {
	...
	if(section != ""){
		$.ajax({
			url: "{{url('admin/testimonies/updateSectionContent')}}",
			type:"POST",
