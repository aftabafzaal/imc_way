...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
					  ...
					  <input type="hidden" name="chkID[]" class="childBox" value="{{$know_Imc->id}}">
						 ...
						 <td style="text-align: center;width:20%;">
							<span>
							   <!-- <div class="kt-user-card-v2"> -->
							   <a href="#"> 		
								  <span><img style="<?php if(empty( $know_Imc->photo1)){ ?>display:none;<?php } ?>" id="iconPreview" width="32"  height="32" src="<?php if(!empty( $know_Imc->photo1)){ ?>{{ $know_Imc->photo1}}<?php } ?>"></span>
							   </a>	  
							   <!-- </div> -->
							</span>
						 </td>
						 <td style="text-align: center;width:20%;">
							<span>
							   <!-- <div class="kt-user-card-v2"> -->
							   <a href="#"> 		
								  <span><img style="<?php if(empty( $know_Imc->video1)){ ?>display:none;<?php } ?>" id="iconPreview" width="32"  height="32" src="<?php if(!empty( $know_Imc->video1)){ ?>{{ $know_Imc->video1}}<?php } ?>"></span>
							   </a>	  
							   <!-- </div> -->
							</span>
						 </td>
   ...
   <div class="col-md-6">
	   ...
	   <div class="kt-portlet">
										...
										<!--begin::Form-->
										<form class="kt-form" method="PUT" enctype="multipart/form-data" action="{{ route('Knowimc.update',[$knowImc_->id]) }} " >
										@csrf

										<input type="hidden" name="id" value="<?php if(!empty($knowImc_->id)){ echo $knowImc_->id; }?> " >
											<div class="kt-portlet__body">
												
												
										<input type="hidden" name="parent_id" value="" >
												<div class="form-group">
													<label>Name Update(EN)</label>
													<input type="text" required name="newsdescription_en" value="{{$knowImc_->newsdescription_en}}" class="form-control" aria-describedby="emailHelp" placeholder="Enter news update in english">
												</div>
												<div class="form-group">
													<label>Name Update(AR)</label>
													<input type="text" required name="newsdescription_ar" value="{{$knowImc_->newsdescription_ar}}" class="form-control" aria-describedby="emailHelp" placeholder="Enter news update in arabic">
												</div>
												<div class="form-group">
													<label>Know Description(EN)</label>
													<input type="text" required name="knowdescription_en" value="{{$knowImc_->knowdescription_en}}" class="form-control" aria-describedby="emailHelp" placeholder="Enter know description in english">
												</div>
												<div class="form-group">
													<label>Know Description(AR)</label>
													<input type="text" required name="knowdescription_ar" value="{{$knowImc_->knowdescription_ar}}" class="form-control" aria-describedby="emailHelp" placeholder="Enter know description in arabic">
												</div>
												...
												<div class="form-group">
													...
													<div class="row">
														...
														<div class="col-md-2" style="text-align: center;margin-top: 5px;">
															<span><img style="<?php if(empty($editmenu->icon)){ ?>display:none;<?php } ?>" id="iconPreview" width="32"  height="32" src="{{$knowImc_->photo1}}"></span>
														</div>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="row">
														...
														<div class="col-md-2" style="text-align: center;margin-top: 5px;">
															<span><img style="<?php if(empty($editmenu->icon)){ ?>display:none;<?php } ?>" id="iconPreview" width="32"  height="32" src="{{$knowImc_->video1}}"></span>
														</div>
													</div>
												</div>
