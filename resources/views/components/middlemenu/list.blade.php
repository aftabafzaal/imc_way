               ...
               <tbody class="kt-datatable__body tbody_sortable" style="">
				   @foreach($menus as $menu)
					  ...
					  <td style="text-align: center;width:20%;">
							<span>
                <span>
                  <a class="socialmiddlemenuicons" href="#"><i class="{{$menu->icon}}" aria-hidden="true"></i></a>
                </span>
								  </span>
							</span>
						 </td>
	   ...
	   <div class="kt-portlet">
                        ...
                        <div class="form-group">
                          ...
                          <select class="custom-select form-control" name="icon">
                            <option value="">Open to select icon</option>
                           <option   <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-facebook"){ echo "selected"; } ?> value="fa fa-facebook">Facebook</option>
                           <option  <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-twitter"){ echo "selected"; } ?> value="fa fa-twitter">Twitter</option>
                           <option  <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-instagram"){ echo "selected"; }?> value="fa fa-instagram">Instagram</option>
                          <option  <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-linkedin"){ echo "selected"; } ?> value="fa fa-linkedin">Linkedin </option>
                           <option  <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-youtube"){ echo "selected"; } ?> value="fa fa-youtube">You Tube</option>
                         </select>
                         <?php
                         if(isset($errors)){
                           ?>
