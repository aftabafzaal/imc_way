...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
				   ...
				   @foreach($menus as $menu)
					  ...
					  <input type="hidden" name="chkID[]" class="childBox" value="{{$menu->id}}">
						 ...
						 <td style="text-align: center;width:{{$width}}%;">
							<span>
							<?php
								echo '<a href="'.url('admin/footer1/list/'.$menu->id.'/submenu').'"><span class="btn btn-bold btn-sm btn-font-sm  btn-label-warning">View Submenus</span></a>';
							?>
							</span>
						 </td>
						 <?php } ?>
   ...
   <div class="col-md-6">
	   ...
	   <div class="kt-portlet">
                    ...
                    <input type="hidden" name="parent_id" value="<?php if(!empty($editmenu->parent_id)){ echo $editmenu->parent_id; }?>" >
                              ...
                              <span></span>
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<a href="{{ url('admin/footer1/list') }}" class="btn btn-secondary" >Cancel</a>
												</div>
											</div>
										</form>
