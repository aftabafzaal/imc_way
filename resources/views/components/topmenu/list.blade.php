					  ...
					  <td style="text-align: center;width:20%;">
						 ...
						 <td style="text-align: center;width:20%;">
							...
							if(!empty($menu->type) && $menu->type=='1'){
								echo '<span class="btn btn-bold btn-sm btn-font-sm  btn-label-success">Link</span>';
							}elseif(!empty($menu->type) && $menu->type=='2'){
								$link = $helper->getPageUrl($menu->page_id);
								echo '<span class="btn btn-bold btn-sm btn-font-sm  btn-label-warning">Inner Page</span>';
							}
							?>
							</span>
						 </td>
                          ...
                          <?php
                           ...
                           ?>
												...
												<div class="form-group">
													<label>Icon</label>
													<div></div>
                          <select class="custom-select form-control" name="icon">
                            <option value="">Select </option>
                           <option    <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-user-circle-o"){ echo "selected"; } ?> value="fa fa-user-circle-o">User Icon</option>
                           <option    <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-graduation-cap"){ echo "selected"; } ?> value="fa fa-graduation-cap">Cap Icon</option>
                           <option    <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-suitcase"){ echo "selected"; } ?> value="fa fa-suitcase">SuitCase Icon</option>
                          <option    <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-book"){ echo "selected"; } ?> value="fa fa-book">Book Icon </option>
                           <option   <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-phone"){ echo "selected"; } ?>  value="fa fa-phone">Phone Icon </option>
                           <option    <?php if(!empty($editmenu->icon) && $editmenu->icon=="fa fa-university"){ echo "selected"; } ?> value="fa fa-university">Residency Program </option>
