...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
   ...
   <div class="col-md-6">
	   ...
	   <div class="kt-portlet">
										...
										<input type="hidden" name="id" value="{{$slider_->id}}" >
											<div class="kt-portlet__body">
												<div class="form-group">
													<label>Name(EN)</label>
													<input type="text" required name="title_en" value="{{$slider_->name_en}}" class="form-control" aria-describedby="emailHelp" placeholder="Enter title in english">
												</div>
												<div class="form-group">
													<label>Name(AR)</label>
													<input type="text" required name="title_ar" value="{{$slider_->name_ar}}" class="form-control" aria-describedby="emailHelp" placeholder="Enter title in arabic">
												</div>
												<div class="form-group">
													<label>Icon</label>
													<div></div>
