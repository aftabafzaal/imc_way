...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
   ...
   <div class="col-md-12">
	   ...
	   <div class="kt-portlet">
                ...
                <!--<label class="col-form-label col-lg-2 col-sm-12"> </label>-->
                <!--<div class="col-lg-9 col-md-9 col-sm-12">-->
                <!--<input maxlength='50' placeholder="Enter Title" id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $editmenu->title }}" required autofocus>-->
                <!--@if ($errors->has('title'))-->
                ...
                <!--<label class="col-form-label col-lg-2 col-sm-12"> </label>-->
                <!--<div class="col-lg-9 col-md-9 col-sm-12">-->
                <!--<input maxlength='50' placeholder="Enter Attribute" id="title" type="text" class="form-control{{ $errors->has('attr') ? ' is-invalid' : '' }}" name="attr" value="{{ $editmenu->attr }}" required autofocus>-->
                <!--@if ($errors->has('attr'))-->
                <!--	<span class="invalid-feedback" role="alert">-->
