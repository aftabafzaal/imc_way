@extends('layouts.app')
@section('title', 'Health tips Section')
@section('content')
			...
			<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
				...
				<div class="kt-section kt-section--first">
					<div class="kt-wizard-v4__form">
                        ...
                        <option value="section_1">Front Image With Text</option>
											</select>
										</div>
									</div>
                  <div class="ajaxdata">
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('health/getSectionContent')}}",
		type:"POST",
...
//  $('#iconFile')[0].files[0];
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('health/updateSectionContent')}}",
			type:"POST",
