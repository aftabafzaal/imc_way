...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            ...
            <!-- <a href="{{ url('knowimcs/create') }}" class="btn btn-label-brand btn-bold">
                Add Know </a> -->
        </div>
    </div>
      ...
      <div class="kt-portlet__body kt-portlet__body--fit">
        ...
        <th data-field="ShipDate" class="kt-datatable__cell kt-datatable__cell--sort">
          ...
          Video
           ...
           $envideo= $helper->getImage($page->media_id_video);
           $img=env('BASE_URL').$enImage;
           $videoimg=env('BASE_URL').$envideo;
           ?>
            ...
            <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 206px;"><img width="32" height="32" src="<?php echo $img;?>"></img></span></td>
             ...
             <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 206px;">
               <video width="32" height="32" controls>
                <source src="<?php echo $videoimg;?>" type="video/mp4">
              </video>
							...
							<span style="overflow: visible; position: relative; width: 80px;">
							   <div class="dropdown">
								  ...
								  <div class="dropdown-menu dropdown-menu-right">
									 <ul class="kt-nav">
										<li class="kt-nav__item"><a class="kt-nav__link" href="{{url('knowimcs/edit', $page->id)}}"><i class="kt-nav__link-icon flaticon2-contract"></i><span class="kt-nav__link-text">Edit</span></a></li>
	...
	function deleteThis(obj, id)
	{
		swal.fire({
			...
			if (result.value) {
				$('.pageloader').show();
				$.ajax({
					url: "<?php echo url('knowimcs/delete-single-page'); ?>",
					type: 'POST',
			...
			if (ids.length > 0) {
				...
				swal.fire({
					...
					if (result.value) {
						$('.pageloader').show();
						$.ajax({
							url: "<?php echo url('knowimcs'); ?>" + '/delete-multiple-pages',
							type: 'POST',
