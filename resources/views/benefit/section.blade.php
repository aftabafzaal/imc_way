...
<div class="kt-grid">
	<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
		...
		<form class="kt-form" id="section_form">
		  @csrf
			<input type="hidden" name="page" value="benefit"/>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9 col-xl-9">
											<select onchange="selectSection(this);" id="section" name="section"  class="form-control{{ $errors->has('template_id') ? ' is-invalid' : '' }}">
												...
												<option value="section_1">Benefits & Facilities</option>
												<!-- <option value="section_2">Get the Right</option> -->
												<option value="section_3">Contact Us</option>
												<option value="section_4">Location</option>
												<option value="section_5">Visiting Hours</option>
											</select>
										</div>
									</div>
									<div class="form-group row">
...
function selectSection(obj) {
	...
	$.ajax({
		url: "{{url('admin/benefit/getSectionContent')}}",
		type:"POST",
...
function updateSection() {
	...
	if($("#section").val() == ""){
		...
		$.ajax({
			url: "{{url('admin/benefit/updateSectionContent')}}",
			type:"POST",
